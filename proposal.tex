...
app. This app will run on Android, using a Postgres database
running on a Ruby server. The app will be released on the Play
Store and available for download from my website.
